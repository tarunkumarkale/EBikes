    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
     ...
     <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Bike</span>
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li className='pt-4' >
                          <a href="https://tailwindcss.com/" class="hover:underline">UI-Snippets</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">Bike™</a>. All Rights Reserved.
          </span>
