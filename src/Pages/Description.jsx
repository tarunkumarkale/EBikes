...
const Description = () => {
  ...
  const {RentFormDataimage,RentFormDataprice,RentFormDatatype,RentFormDataNAME}=useContext(AllDataContext)
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          <div className="flex justify-between items-center mb-4">
            <p className="text-lg">{third}</p>
          </div>

       

          <div className="flex items-center gap-9 mt-3">
            <button className="px-4 py-2 bg-blue-400 text-white hover:bg-blue-800 transition duration-300">{first?'Rent Now':'Buy Now'}</button>
...
<p className='text-xl'>Accessories: Comes with essential accessories like a water bottle holder, kickstand, and reflectors for added convenience and safety.</p>
   ...
   {first? <ParentRent  scrollToTop={scrollToTop}  />:''}
