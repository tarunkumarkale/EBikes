...
const AllOrderProducts = React.memo(() => {
  ...
  return (
    <>
      ...
      <div className="container mx-auto p-4">
        {/* Heading */}
        <h2 className="text-3xl font-extrabold text-center mb-10 text-gray-800" data-aos="fade-up">Rent Orders</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {orders.map((order, index) => (
            ...
            >
              ...
              <div className="p-6 bg-gradient-to-r from-gray-100 to-gray-50 text-center">
                <h3 className="text-xl font-bold text-purple-700 mb-3 uppercase">
                  <span className='text-black'>Renter Name :</span> {order.name}
                </h3>
